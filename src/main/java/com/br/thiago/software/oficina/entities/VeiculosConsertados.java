...
@Entity
public class VeiculosConsertados {
	...
	public VeiculosConsertados() {

	}

	public VeiculosConsertados(String nomeCliente, String emailCliente, long numeroCliente1, long numeroCliente2,
